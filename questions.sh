...
if [[ ("$wireguard" == "true") ]]; then
message_box "Yiimpool Yiimp installer v1.0.2" \
"You have choosen to install Yiimpool Yiimp v1.0.2 with WireGuard!
...
message_box "Yiimpool Yiimp installer v1.0.2" \
"You have choosen to install Yiimpool Yiimp v1.0.2!
