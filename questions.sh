...
if [[ ("$wireguard" == "true") ]]; then
message_box "Yiimpool Yiimp installer v1.0.3" \
"You have choosen to install Yiimpool Yiimp v1.0.3 with WireGuard!
...
message_box "Yiimpool Yiimp installer v1.0.3" \
"You have choosen to install Yiimpool Yiimp v1.0.3!
