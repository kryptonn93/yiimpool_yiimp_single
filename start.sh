...
if [[ ("$UsingDomain" == "yes") ]]; then
  echo -e "Installation of your Yiimpool Yiimp v1.0.3.3 is now completed."
...
echo
echo -e "$YELLOW Happy mining :) <3 Afiniel $COL_RESET"
echo "----------------------------------------------------------------------------"
echo
echo -e "$GREEN Thank you for using Afiniel Yiimpool Installer v1.0.3.3!$COL_RESET"
echo
echo -e "$YELLOW To run this installer anytime simply type, $COL_RESET $GREEN yiimpool $COL_RESET"
echo -e "$YELLOW If you want to support me by donation, please use wallets bellow: $COL_RESET"
echo
